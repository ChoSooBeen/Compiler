...
public class GraphViz
{
    ...
    private final static String cfgProp = currentRelativePath.toAbsolutePath().toString() + "\\src\\Parser\\config.properties";
    ...
    private static String DOT = configFile.getProperty("dotForMacOSX");
